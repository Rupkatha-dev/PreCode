      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {phase === "done" && (
          <div className="max-w-2xl mx-auto text-center py-16">
            ...
            <p className="text-neutral-500 mb-8">Your session has been saved. Good work thinking before coding.</p>
            <Link
              href="/"
              className="inline-block px-6 py-2 bg-white text-black hover:bg-neutral-200 rounded-sm font-medium transition-colors"
            >
              Return Home
            </Link>
          </div>
